...
Using requests library instead of openai package
August 11, 2025
"""
...
def main():
    ...
    # Save all outputs
    output_file = "/mnt/c/projects/ai-agents/ai-dna-discovery/jetson-sensors/coherence-engine/gpt_mcp_design_session.json"
    gpt.save_outputs(output_file)
    
    print(f"\nTotal API calls used: {gpt.call_count}/{gpt.max_calls}")
    print(f"Session complete. Check {output_file} for full log.")
